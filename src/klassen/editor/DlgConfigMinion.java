 ...
 * @author Julian
 */
public class DlgConfigMinion extends JDialog {
    private List<String> types = new ArrayList<>();
    private List<JTextField> inputs = new ArrayList<>();
    private klassen.minion.Minion minion;
    private boolean ready = false;
    
    public DlgConfigMinion(JFrame owner, klassen.minion.Minion obj) {
        super(owner, "Configure Minion", true);
        minion = obj;
        ...
        btConfig.setAction(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    minion = (klassen.minion.Minion) minion.getClass().getConstructors()[0].newInstance(values.toArray());
                    ready = true;
                } catch (Exception ex) {
    ...
    public klassen.minion.Minion getMinion() {
        return minion;
    }
}
