...
//    }
  ...
  public void loadLevel(int i,float startX,float startY)
  {
    ...
    switch(i)
    {
      case 0:test(startX,startY);
        break;
      case 1:tutorial(startX, startY, new GameObjects[100][100]);
        break;
      case 2:haus(startX,startY);
        break;
      case 3:route101(startX,startY);
        break;
    }
    pause=false;
  }
  public void tutorial(float startX,float startY,GameObjects map[][])
  {
    ...
    for (int i = 0; i < 4; i++) 
    {
      for (int j = 0; j < 21; j++)
      {
        map[i+42][j]=new Arrow(brightness,3, -866.0f, -1773.0f, this);
      }
    }
